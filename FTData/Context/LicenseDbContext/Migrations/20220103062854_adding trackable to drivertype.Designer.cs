...
namespace FTData.DbContext.LicenseDbContext.Migrations
{
    ...
    [Migration("20220103062854_adding trackable to drivertype")]
    partial class addingtrackabletodrivertype
    {
            ...
            modelBuilder.Entity("FTData.Model.LicenseModel.Entities.Estimate", b =>
                {
                    ...
                    b.HasOne("FTData.Model.LicenseModel.Entities.LicenseUser", "LicenseUser")
                        .WithMany("Estimates")
